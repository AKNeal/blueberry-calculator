...
export const RECIPES: Recipe[] = [
  ...
  // ============ PIES & TARTS (batch 2) ============
  {
    ...
    difficulty: "Medium",
    heroImage: placeholderImg("blueberry-galette", "hero"),
    ingredientsImage: placeholderImg("blueberry-galette", "ingredients"),
    tested: false,
    ingredients: [
...

  {
    ...
    difficulty: "Medium",
    heroImage: placeholderImg("blueberry-hand-pies", "hero"),
    ingredientsImage: placeholderImg("blueberry-hand-pies", "ingredients"),
    tested: false,
    ingredients: [
...

  {
    ...
    difficulty: "Advanced",
    heroImage: placeholderImg("lemon-blueberry-tart", "hero"),
    ingredientsImage: placeholderImg("lemon-blueberry-tart", "ingredients"),
    tested: false,
    ingredients: [
  ...
  // ============ BREAKFAST (batch 2) ============
  {
    ...
    difficulty: "Easy",
    heroImage: placeholderImg("blueberry-baked-oatmeal", "hero"),
    ingredientsImage: placeholderImg("blueberry-baked-oatmeal", "ingredients"),
    tested: false,
    ingredients: [
...

  {
    ...
    difficulty: "Easy",
    heroImage: placeholderImg("blueberry-banana-smoothie", "hero"),
    ingredientsImage: placeholderImg("blueberry-banana-smoothie", "ingredients"),
    tested: false,
    ingredients: [
...

  {
    ...
    difficulty: "Medium",
    heroImage: placeholderImg("blueberry-french-toast-bake", "hero"),
    ingredientsImage: placeholderImg("blueberry-french-toast-bake", "ingredients"),
    tested: false,
    ingredients: [
  ...
  // ============ PRESERVES (batch 2) ============
  {
    ...
    difficulty: "Easy",
    heroImage: placeholderImg("blueberry-syrup", "hero"),
    ingredientsImage: placeholderImg("blueberry-syrup", "ingredients"),
    tested: false,
    ingredients: [
      { amount: "2 cups", item: "fresh blueberries", berries: 198 },
...

  {
    ...
    difficulty: "Easy",
    heroImage: placeholderImg("blueberry-compote", "hero"),
    ingredientsImage: placeholderImg("blueberry-compote", "ingredients"),
    tested: false,
    ingredients: [
      { amount: "2 cups", item: "fresh blueberries, divided", berries: 198 },
...

  {
    ...
    difficulty: "Easy",
    heroImage: placeholderImg("blueberry-chia-jam", "hero"),
    ingredientsImage: placeholderImg("blueberry-chia-jam", "ingredients"),
    tested: false,
    ingredients: [
      { amount: "2 cups", item: "fresh blueberries", berries: 198 },
